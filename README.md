...
- **Tools:** Git Version Control & Github, AWS, Postman, Azure Devops, Powershell, Bash, SQL Server Management Studio, SQL Server Reporting Services, MongoDB, Wireshark, Swagger, Splunk, TrueNAS, pfSense
...
- **Description:** Designed and implemented a secure password manager.
